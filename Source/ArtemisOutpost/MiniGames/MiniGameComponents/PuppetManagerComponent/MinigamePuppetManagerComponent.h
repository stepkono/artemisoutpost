...
#include "MinigamePuppetManagerComponent.generated.h"
...
class ARTEMISOUTPOST_API UMinigamePuppetManagerComponent : public UActorComponent
{
	GENERATED_BODY()

public:
	UMinigamePuppetManagerComponent();
